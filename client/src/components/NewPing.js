        ...
        <Grid container alignItems="center" justify="center">
          ...
          <Grid item style={{ margin: 10, marginTop: 25 }}>
            <input id="file" style={{ display: "none" }}
              ...
              accept="image/*"
            />
            <label className={classes.fileBtn} htmlFor="file">Choose a file</label>
          </Grid>
        </Grid>
      </form>
      {previewSource && (
        <img src={previewSource} alt="preview of choosen file" style={{height: "250px", display: "block", margin: "0 auto", marginTop: 20}}/>
      )}
    </Paper>
  )
}
